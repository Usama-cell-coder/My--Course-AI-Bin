...
df = pd.read_csv(r'E:\DataSets_AI_Course\zameencom-property-data-By-Kaggle-Short.csv',delimiter=";", parse_dates=[14],  date_format={'date_added': '%m-%d-%Y'} , index_col='property_id')
