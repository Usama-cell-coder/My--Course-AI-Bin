...
ids, price , long , lat = np.genfromtxt('E:\DataSets_AI_Course\zameencom-property-data-By-Kaggle-Short.csv', delimiter=';', usecols=(0,4,8,9), unpack=True, dtype=None,skip_header=1)
