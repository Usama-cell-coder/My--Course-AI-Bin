...
ids, price , long , lat = np.genfromtxt(r'C:\Users\PMLS\Documents\GitHub\FULL-STACK-B-8-Wed-Thru-Fri\Week4\zameencom-property-data-By-Kaggle-Short.csv', delimiter=';', usecols=(0,4,8,9), unpack=True, dtype=None,skip_header=1)
